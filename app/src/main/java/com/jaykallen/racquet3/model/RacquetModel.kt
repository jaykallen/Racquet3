...
data class RacquetModel (
    ...
    @ColumnInfo(name = "weight") var weight: Double = 300.0,                    // Overall weight
    @ColumnInfo(name = "balance") var balance: String = "Light",                // This could be an enum
    ...
    constructor() : this(0, "Default", "Inches", 100.0, 27.0, 300.0, "Even", 13.5, 0.0, "Luxilon", "16x19", 50.0, "")
}